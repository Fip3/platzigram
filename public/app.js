...
},{"global/document":6,"hyperx":9,"on-load":42}],2:[function(require,module,exports){
...
},{"./lib/locales":2,"./lib/main":26}],22:[function(require,module,exports){
/*
Copyright (c) 2014, Yahoo! Inc. All rights reserved.
Copyrights licensed under the New BSD License.
See the accompanying LICENSE file for terms.
...
},{"./diff":23,"./es5":25,"intl-messageformat":27}],23:[function(require,module,exports){
/*
Copyright (c) 2014, Yahoo! Inc. All rights reserved.
Copyrights licensed under the New BSD License.
See the accompanying LICENSE file for terms.
...
},{"./core":22,"./en":24,"dup":15}],27:[function(require,module,exports){
arguments[4][10][0].apply(exports,arguments)
},{"./lib/locales":2,"./lib/main":32,"dup":10}],28:[function(require,module,exports){
arguments[4][11][0].apply(exports,arguments)
},{"dup":11}],29:[function(require,module,exports){
arguments[4][12][0].apply(exports,arguments)
},{"./compiler":28,"./es5":31,"./utils":33,"dup":12,"intl-messageformat-parser":34}],30:[function(require,module,exports){
arguments[4][13][0].apply(exports,arguments)
},{"dup":13}],31:[function(require,module,exports){
arguments[4][14][0].apply(exports,arguments)
},{"./utils":33,"dup":14}],32:[function(require,module,exports){
arguments[4][15][0].apply(exports,arguments)
},{"./core":29,"./en":30,"dup":15}],33:[function(require,module,exports){
arguments[4][16][0].apply(exports,arguments)
},{"dup":16}],34:[function(require,module,exports){
arguments[4][17][0].apply(exports,arguments)
},{"./lib/parser":35,"dup":17}],35:[function(require,module,exports){
...
},{"./lib/core.js":37,"./locale-data/complete.js":2}],37:[function(require,module,exports){
'use strict';
...
},{"global/document":6,"global/window":7}],43:[function(require,module,exports){
(function (process){
...
},{"_process":3,"path-to-regexp":44}],44:[function(require,module,exports){
...
},{"isarray":40}],45:[function(require,module,exports){
/**
...
},{"./is-object":46,"./request":48,"./request-base":47,"emitter":4}],46:[function(require,module,exports){
/**
...
},{"./update-events.js":51,"bel":1,"morphdom":41}],51:[function(require,module,exports){
module.exports = [
      ...
      <div class="row">
        <div class="col s12 l3 center-align"><a href="#" data-activates="dropdown1" class="dropdown-button btn btn-flat">${ translate.message('language') }</a>
          <ul id="dropdown1" class="dropdown-content">
            <li><a onclick=${ lang.bind(null, 'es') }>${ translate.message('spanish') }</a></li>
            <li><a onclick=${ lang.bind(null, 'en-US') }>${ translate.message('english') }</a></li>
          </ul>
        </div>
...
},{"../translate":66,"yo-yo":50}],53:[function(require,module,exports){
var yo = require('yo-yo');
var translate = require('../translate');
...
},{"../translate":66,"empty-element":5,"yo-yo":50}],54:[function(require,module,exports){
...
},{"../header":53,"./template":55,"empty-element":5,"page":43,"superagent":45,"title":49}],55:[function(require,module,exports){
var yo = require('yo-yo');
...
},{"../layout":58,"../picturecards":59,"yo-yo":50}],56:[function(require,module,exports){
var page = require('page');
...
},{"./footer":52,"./header":53,"./homepage":54,"./signin":60,"./signup":62,"page":43}],57:[function(require,module,exports){
var yo = require('yo-yo');
...
},{"yo-yo":50}],58:[function(require,module,exports){
var yo = require('yo-yo');
var translate = require('../translate');
...
},{"../translate":66,"yo-yo":50}],59:[function(require,module,exports){
var yo = require('yo-yo');
var translate = require('../translate');
...
},{"../translate":66,"yo-yo":50}],60:[function(require,module,exports){
var page = require('page');
var empty = require('empty-element');
var template = require('./template');
var title = require('title');
...
page('/signin', function (ctx, next) {
  title('Platzigram - Inscripción');
  var main = document.getElementById('main-container');
  empty(main).appendChild(template);
});

},{"./template":61,"empty-element":5,"page":43,"title":49}],61:[function(require,module,exports){
var yo = require('yo-yo');
...
},{"../landing":57,"../translate":66,"yo-yo":50}],62:[function(require,module,exports){
var page = require('page');
var empty = require('empty-element');
var template = require('./template');
var title = require('title');
...
page('/signup', function (ctx, next) {
  title('Platzigram - Ingresa');
  var main = document.getElementById('main-container');
  empty(main).appendChild(template);
});

},{"./template":63,"empty-element":5,"page":43,"title":49}],63:[function(require,module,exports){
var yo = require('yo-yo');
var landing = require('../landing');
var translate = require('../translate');
...
},{"../landing":57,"../translate":66,"yo-yo":50}],64:[function(require,module,exports){
module.exports = {
          ...
          'english': 'English',
          'spanish': 'Spanish',
          'signup.subheading': 'Signup and share your photos with your Platzi classmates',
...
module.exports = {
  ...
  'english': 'Inglés',
  'spanish': 'Español',
  'signup.subheading': 'Inscríbete y ve a tus compañeros de Platzi',
  ...
  'password': 'Contraseña',
  'signup.call-to-action': 'Inscríbete',
...
module.exports = {
  message: function (txt, opts) {
    opts = opts || {};
    var msg = new IntlMessageFormat(MESSAGES[locale][txt], locale, null);
    return msg.format(opts);
  },
  date: new IntlRelativeFormat(locale)
};

},{"./en-US":64,"./es":65,"intl":36,"intl-messageformat":10,"intl-relativeformat":21,"intl-relativeformat/dist/locale-data/en.js":19,"intl-relativeformat/dist/locale-data/es.js":20,"intl/locale-data/jsonp/en-US.js":38,"intl/locale-data/jsonp/es.js":39}]},{},[56]);
