      ...
      <div class="signup-box">
        ...
        <form class="signup-form" action="/login" method="POST">
          <div class="section">
            ...
            <a href="/auth/facebook" rel="external" class="btn btn-fb hide-on-med-and-up"><i class="fa fa-facebook-official" aria-hidden="true"></i>${translate.message('signup.text')}</a>
          </div>
